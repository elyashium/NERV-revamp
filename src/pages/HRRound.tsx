              ...
              <div className="flex-shrink-0 px-5 py-4 border-t border-white/10 space-y-3">
                ...
                <form onSubmit={handleChatSubmit} className="flex space-x-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 bg-white/5 border border-white/15 rounded-xl text-white text-sm placeholder-gray-500 focus:outline-none focus:border-purple-500/60 focus:bg-white/10 transition-all"
                  />
                  <button
                    type="submit"
                    className="px-5 py-2.5 bg-purple-600 hover:bg-purple-500 text-white text-sm rounded-xl transition-colors font-medium"
                  >
                    Send
                  </button>
                </form>
